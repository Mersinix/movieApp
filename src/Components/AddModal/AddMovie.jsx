...
const AddMovie=({adding})=>{
    ...
    function openModal() {
      ...
      const addingMovie = (e) => {
        let newMovie = {title,year,rating,image,genre,synopsis,};
        adding(e, newMovie);
        setIsOpen(false);
        setTitle("");
        setYear("");
      ...
      return (
        <div className="addmodal">
          ...
          >
            ...
            <img src="/img/ayou.jpg" alt="" 
              style={{ width: "300px", height: "400px", borderRadius: "10px", margin: "5px" }}/>
          </Modal>
        </div>
      );
};
